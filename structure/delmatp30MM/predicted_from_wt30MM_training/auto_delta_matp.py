...
data = np.loadtxt("expt_pij_d_matp30MM_5kb.mat")
...
np.savetxt(f"latent_data/latent_data_hic_latent_dim_3_delta_matp.txt", latent_data, delimiter = "\t", fmt = "%0.3e")

np.savetxt("output_data/output_matrix_delta_matp.mat", output, fmt = "%0.3e")
